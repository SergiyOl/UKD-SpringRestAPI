...
// public AuthController(UserServiceImpl userService, SecurityConfig
...
// logger.info("Received Login request (username: " + username + " ; password: "
// + password + " )");
...
// public ResponseEntity<Void> registerUser(@RequestBody String username, String
// password) {
// logger.info("Received Register request (username: " + username + " ;
// password: " + password + " )");
